...
{
    public class TimeRangeHelper : IChronoxParseHelper<ChronoxTimeRangeExtraction>
    {
        ...
        public void ProcessDecimalNumber(ChronoxTimeRangeExtraction result, List<GroupWrapper> foundGroups, ref DateTime dateTime, ChronoxBuildInformation information, string value)
        {
            throw new NotImplementedException();
        }
        ...
        public void ProcessTimeZoneInformation(ChronoxTimeRangeExtraction result, List<GroupWrapper> foundGroups, ref DateTime dateTime, ChronoxBuildInformation information, GroupWrapper GroupWrapper)
        {
            throw new NotImplementedException();
        }
    }
